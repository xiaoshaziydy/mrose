...
# ==========================================
# 1. 3' UTR biological feature extraction 
# ==========================================
...
def calculate_codon_features(rna_seq):
    codon_to_aa = {
        ...
        'ATT': 'codon_I', 'ATC': 'codon_I', 'ATA': 'codon_I', 'ATG': 'uAUG',  
        ...
        'TAT': 'codon_Y', 'TAC': 'codon_Y', 'TAA': 'codon_*', 'TAG': 'codon_*', 
        'CAT': 'codon_H', 'CAC': 'codon_H', 'CAA': 'codon_Q', 'CAG': 'codon_Q',
        'AAT': 'codon_N', 'AAC': 'N', 'AAA': 'K', 'AAG': 'K',
        'GAT': 'codon_D', 'GAC': 'codon_D', 'GAA': 'codon_E', 'GAG': 'codon_E',
        'TGT': 'codon_C', 'TGC': 'codon_C', 'TGA': 'codon_*', 'TGG': 'codon_W',  
...
def compute_features_3utr(utr):
    utr = str(utr).upper().replace(" ", "")
    features = calculate_codon_features(utr)
...
# ==========================================
# 3. 3' UTR main model wrapper 
# ==========================================
# ==========================================
# 3. 3' UTR main model wrapper with bug fixes and dynamic length support
# ==========================================

class Model_3UTR(nn.Module):  
    def __init__(self, vocab_size, embed_dim=128, hidden_dim=256, latent_dim=128, num_heads=8,
                 num_encoder_layers=2, num_decoder_layers=2, num_embeddings=32, commitment_cost=0.1):  
        super(Model_3UTR, self).__init__()  
    ...
    def encode(self, src):  
        ...
        # --- Added: dynamic sequence length truncation and padding ---


        # --- Fix: generate the padding mask from token IDs before embedding ---
        src_key_padding_mask = (src == 0)

        # --- Fix: pass the true seq_len ---
